...
function iCalendar() {
	...
	this._defaults = {
		...
		icons: '/images/cal-bw-01.png', // Horizontal amalgamation of all site icons
		iconSize: 32,  // The size of the individual icons
		...
		tipPrefix: 'Save to ',  // Additional text to show in the tool tip for each icon
		...
		copyFlash: '', // The URL for the Flash clipboard copy module
	...
	this._sites = {  // The definitions of the available iCalendar sites
		'google': {display: 'Google', icon: 1, override: null,
			url: 'http://www.google.com/calendar/event?action=TEMPLATE' +
			'&amp;text={t}&amp;dates={s}/{e}&amp;details={d}&amp;location={l}&amp;sprop=website:{u}'},
		'icalendar': {display: 'iCalendar', icon: 1, override: null, url: 'echo'},
		'outlook': {display: 'Outlook', icon: 1, override: null, url: 'echo'},
		'yahoo': {display: 'Yahoo', icon: 1, override: yahooOverride,
