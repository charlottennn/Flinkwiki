...
class Permissions extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'joinRolePermissions' => array(self::HAS_MANY, 'JoinRolePermission', 'permission_id'),
			'joinSectionPermissions' => array(self::HAS_MANY, 'JoinSectionPermission', 'permission_id'),
		);
	}
